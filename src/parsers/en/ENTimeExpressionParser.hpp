...
namespace time { namespace  parser {
    ...
    private:
        ...
        static const unsigned short MINUTE_GROUP      = 3;
        static const unsigned short SECOND_GROUP      = 4;
        // static const unsigned short  MILLI_SECOND_GROUP= 5;
        static const unsigned short AM_PM_HOUR_GROUP  = 6;
        static const unsigned short TO_GROUP          = 7;
        static const unsigned short TO_HOUR_GROUP     = 10;
        static const unsigned short TO_MINUTE_GROUP   = 11;
        static const unsigned short TO_SECOND_GROUP   = 12;
        static const unsigned short TO_MERIDIEM_GROUP = 14;
