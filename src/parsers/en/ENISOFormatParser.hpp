...
namespace time { namespace parser {
    ...
    private:
        ...
        static const unsigned short  MONTH_NUMBER_GROUP       = 3;
        static const unsigned short  DATE_NUMBER_GROUP        = 4;
        static const unsigned short  HOUR_NUMBER_GROUP        = 5;
        static const unsigned short  MINUTE_NUMBER_GROUP      = 6;
        static const unsigned short  SECOND_NUMBER_GROUP      = 7;
        // static const unsigned short  MILLISECOND_NUMBER_GROUP = 8;
        static const unsigned short  TZD_HOUR_OFFSET_GROUP    = 9;
        static const unsigned short  TZD_MINUTE_OFFSET_GROUP  = 10;
